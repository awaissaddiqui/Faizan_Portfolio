  ...
  return (
    <div>
          ...
          <div className="space-y-10 ms-2 mt-5">
            <div className="inline-flex items-center gap-3">
              ...
              <a href="mailto:shahfaizam@gmail.com" className="text-gray-400 hover:text-gray-300 cursor-pointer">
                shahfaizam@gmail.com
              </a>
            </div>
            <div className="flex items-center gap-3">
              <FiPhone className="text-lg text-gray" />
              <span className="text-gray-400">+9233333333333</span>
            </div>
            <div className="flex items-center gap-3">
        ...
        <div className="p-6 rounded-lg">
          <form onSubmit={handleSubmit} className="space-y-4">
            <input
              ...
              required
              className="w-full p-3 bg-black text-white rounded-md border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
            />
            <input
              type="email"
              name="email"
      ...
      <div className="flex wrap justify-center gap-10 mt-8">
        <a href="https://instagram.com/#" className="inline-flex items-center gap-2 text-gray-400 hover:text-blue-500 cursor-pointer">
          <FaInstagram className='text-2xl' /> Instagram
        </a>
        <a href="https://github.com/#" className="inline-flex items-center gap-2 text-gray-400 hover:text-blue-500 cursor-pointer">
          <FaGithub className='text-2xl' /> Github
        </a>
        <a href="https://www.linkedin.com/in/#" className="inline-flex items-center gap-2 text-gray-400 hover:text-blue-500 cursor-pointer">
